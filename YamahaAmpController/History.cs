...
namespace YamahaAmpController
{
    public partial class History : Form
    {
        ...
        public History(Main caller)
        {
            ...
            this.dataGridView1.DataSource = caller.History.Select(x=>new { Date = x.Item1.ToShortDateString(), Time = x.Item1.ToLongTimeString(), x.Item2.Artist, x.Item2.Title, x.Item2.Album }).ToList();
            Redraw();
